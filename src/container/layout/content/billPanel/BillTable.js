...
import { setSelectedBills, payBill, openPayBillModal, setSelectedBillToPay} from 'reducers/bills/actions';
...
class BillTable extends React.Component<Props> {
  ...
  showPayModal = (bill) => {
    ...
    this.props.actions.setSelectedBillToPay(bill);
  }
